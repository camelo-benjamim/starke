# Generated by Django 3.2.16 on 2022-11-29 02:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users_may_access', models.ManyToManyField(related_name='users_may_access', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Sensor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iot_device_actuator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='iot_connections.iotdevice')),
            ],
        ),
    ]
